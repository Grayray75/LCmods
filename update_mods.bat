...
call:downloadModPackage "Tolian-Celestria" "0.4.7"
call:downloadModPackage "Tolian-EchoReach" "0.2.2"
call:downloadModPackage "Tolian-Maritopia" "0.3.7"
call:downloadModPackage "Tolian-PsychSanctum" "0.1.3"
